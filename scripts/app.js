...
function hideCowinButton(){
    const cowinButton = document.querySelector('#cowin-link-button');
    cowinButton.classList.add('hide-content');
}
function makeCowinButtonVisible(){
    const cowinButton = document.querySelector('#cowin-link-button');
    cowinButton.classList.remove('hide-content');
}
